...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "L'Écho du Corbeau",
        short_name: 'Echo Corbeau',
        description: 'Application de criminalistique audio immersive',
        theme_color: '#0a0e27',
      ...
      workbox: {
        globPatterns: ['**/*.{js,css,html,ico,png,svg,woff,woff2,mp3,wav,jpg,jpeg}'],
        runtimeCaching: [
          {
